...
public class Collation extends JDialog {
    ...
    public  Collation(MainUI UI) {
        ...
        JRadioButton DeskTop = new JRadioButton("C:\\Users\\" + Function.Collation.userName + "\\Desktop");
        JRadioButton OneDrive = new JRadioButton("C:\\Users\\" + Function.Collation.userName + "\\OneDrive\\Desktop");
        ...
        if (file.exists()) {
            ...
            if (data.equals("C:\\Users\\" + Function.Collation.userName + "\\Desktop")) {
                DeskTop.setSelected(true);
            } else if (data.equals("C:\\Users\\" + Function.Collation.userName + "\\OneDrive\\Desktop")) {
