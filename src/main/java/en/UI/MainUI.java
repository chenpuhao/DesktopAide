...
import en.Function.Communicate;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Collation.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                en.UI.Collation collation = new Collation(UI);
        ...
        Communicate.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                en.Function.Communicate communicate = new Communicate();
                communicate.run();
            }
        });
